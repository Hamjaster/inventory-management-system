        ...
        <>
            ...
            <div className="actions bg-[#] bg-white px-4 py-3 flex flex-row items-center justify-between space-x-1">
                ...
                <div className="actions w-2/4 sm:w-1/4">
                    <Link to={'/sales/add'} className="create flex justify-center flex-row items-center space-x-2 bg-[#00BE95] hover:bg-[#01876a] transition-all text-white text-center px-0 py-3 sm:px-4 text-sm sm:text-lg sm:py-2 cursor-pointer">
